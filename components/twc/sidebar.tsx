...
export const SidebarItem = forwardRef(function SidebarItem(
  ...
  const classes = clsx(
    // Base
    'flex w-full cursor-pointer items-center gap-3 px-2 py-3.5 text-left text-base/6 sm:py-3 sm:text-sm/5',
    // Font weight: normal by default, medium when current
    current ? 'font-medium text-zinc-950' : 'font-normal text-zinc-600',
    ...
    // Hover
    'data-hover:bg-zinc-950/5 data-hover:*:data-[slot=icon]:fill-zinc-950 data-hover:text-zinc-950',
    // Active
    ...
    <span className={clsx(className, 'relative')}>
      {current && (
        <motion.span
          ...
          className="absolute inset-y-2 -left-4 w-0.5 bg-zinc-950"
        />
      )}
