...
/**
 * Standardized empty state component for tables
...
export function TableEmptyState({
  ...
  return (
    <div
      className={clsx(
        'rounded-lg border border-zinc-200 bg-zinc-50/50 p-8 text-center',
        className
      )}
    >
      {Icon && (
      ...
      <Text className="font-medium text-zinc-700">{title}</Text>
      {description && (
...
/**
 * Pre-configured empty state icons for common table types
 */
