...
const searchMessages = [
  ...
  // SEC & Regulatory
  'Parsing 13F disclosures',
  'Decoding Schedule 13D',
  'Reading the fine print',
  'Auditing the footnotes',
  'Checking beneficial ownership',
  'Scanning EDGAR filings',
  'Reviewing proxy statements',
  'Analyzing Form 4s',
  'Cross-referencing CIKs',
  'Validating CUSIPs',
  'Tracing accession numbers',
  'Checking reporting thresholds',
  'Reviewing material changes',
  'Scanning amendment filings',
  'Parsing XML submissions',
  // Institutional Holdings
  'Tracking smart money',
  'Following the whales',
  'Mapping institutional flows',
  'Calculating AUM shifts',
  'Measuring conviction buys',
  'Spotting position changes',
  'Analyzing portfolio turnover',
  'Tracking hedge fund moves',
  'Monitoring pension allocations',
  'Checking mutual fund holdings',
  'Surveying ETF compositions',
  'Measuring concentration risk',
  'Tracking sector rotations',
  'Analyzing style drift',
  'Monitoring cash positions',
  // Insider Activity
  'Watching insider trades',
  'Tracking C-suite moves',
  'Monitoring director purchases',
  'Checking 10b5-1 plans',
  'Scanning Form 144 filings',
  'Reviewing insider clusters',
  'Tracking officer sales',
  'Measuring insider sentiment',
  'Spotting unusual activity',
  'Checking blackout periods',
  'Reviewing compensation grants',
  'Analyzing option exercises',
  'Tracking automatic sales',
  'Monitoring gift transactions',
  // Market Analysis
  'Calculating ownership concentration',
  'Measuring float dynamics',
  'Analyzing short interest',
  'Checking days to cover',
  'Reviewing cost basis data',
  'Calculating average entry',
  'Measuring position sizing',
  'Analyzing dollar volumes',
  'Tracking money flows',
  'Reviewing market cap tiers',
  'Checking liquidity metrics',
  'Analyzing trading patterns',
  // Wall Street Culture
  'Consulting the Bloomberg terminal',
  'Checking the tape',
  'Reading the order book',
  'Scanning Level 2 data',
  'Reviewing dark pool prints',
  'Checking block trades',
  'Analyzing unusual volume',
  'Monitoring price discovery',
  'Following activist campaigns',
  'Tracking proxy contests',
  'Reviewing tender offers',
  'Checking merger arb spreads',
  // Data Operations
  'Normalizing ticker symbols',
  'Resolving entity names',
  'Mapping security identifiers',
  'Aggregating position data',
  'Reconciling share counts',
  'Validating market values',
  'Calculating percentages',
  'Sorting by conviction',
  'Filtering noise',
  'Ranking by significance',
  'Grouping by strategy',
  'Clustering similar filers',
  // Cheeky Finance
  'Asking Warren for advice',
  'Channeling Peter Lynch',
  'Consulting the efficient market',
  'Checking if markets are open',
  'Verifying it\'s not a holiday',
  'Looking under the mattress',
  'Checking the couch cushions',
  'Asking the Fed nicely',
  'Reviewing the Beige Book',
  'Consulting tea leaves',
  'Reading the entrails',
  'Phoning a friend on the Street',
  'Checking with compliance',
  'Running it by legal',
  'Getting sign-off from risk',
  'Asking the quants',
  'Pinging the algo',
]
