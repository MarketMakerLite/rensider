...
export const metadata: Metadata = {
  ...
  title: {
    default: "Rensider | Track What the Smart Money is Buying",
    template: "%s | Rensider",
  },
  ...
  generator: "Next.js",
  keywords: ["institutional ownership", "hedge funds", "stock holdings", "insider trading", "smart money", "investment research"],
