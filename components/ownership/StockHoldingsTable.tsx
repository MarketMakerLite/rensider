...
function calculateShareChange(shares: number, changePercent: number | null): number | null {
  ...
  // If changePercent = x%, then: previousShares = shares / (1 + x/100)
  // shareChange = shares - previousShares
...
export function StockHoldingsTable({ holders }: StockHoldingsTableProps) {
