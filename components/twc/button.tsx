...
const styles = {
  base: [
    ...
    // Sizing - tighter padding for professional density
    'px-[calc(--spacing(3)-1px)] py-[calc(--spacing(2)-1px)] sm:px-[calc(--spacing(2.5)-1px)] sm:py-[calc(--spacing(1.5)-1px)] sm:text-sm/6',
    // Focus
...
export const Button = forwardRef(function Button(
  ...
  return typeof props.href === 'string' ? (
    <Link {...props} className={clsx(classes, 'cursor-pointer')} ref={ref as React.ForwardedRef<HTMLAnchorElement>}>
